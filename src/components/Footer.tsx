...
import { FaArrowRight, FaInstagram, FaEdge } from "react-icons/fa"
import { FaThreads, FaChrome, FaSafari, FaFirefoxBrowser } from "react-icons/fa6"

function Footer() {
  return (
    // Footer Component HTML Tags
    <footer>
