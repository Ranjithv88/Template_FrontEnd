...
function DashBoard() {
   ...
   // DashBoard Page variable and Hooks 
    ...
    // otp verify SuccessFully Animation Function
    ...
    // Validation process For Input Data 
    ...
    // view Options For Section Function
    ...
    // view Options for Click Function
  ...
  return (
    // DashBoard Page HTML tags
    <>
    {/* Below Condition is true that will be Display Loading Component OtherWise that is Display the DashBoard page */}
      {loadingProcess?<Loading/>:<>
        {access?
          <div className='DashBoard'>
            ...
            <div className='DashBoardContent'>
              {/* Inform the To Click Option Div */}
              ...
              {/* user Personal Details Show Div */}
              ...
              {/* this is the verification for Email and PhoneNumber */}
              ...
              {/* Coming Soon Features HTMl Tags */}
            ...
            {/* this is Terms and Conditions Content Page */}
        ...
        {/* this is error message for TimeOut Process HTML tag */}
